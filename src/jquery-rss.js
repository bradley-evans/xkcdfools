(function ($) {
  ...
  RSS.prototype.getTokenMap = function (entry) {
    ...
    return $.extend({
      ...
      url:       entry.link,
      author:    entry.author.replace(/squelch21/gi, 'Bradley Evans'),
      date:      this.getFormattedDate(entry.publishedDate),
      title:     entry.title,
      body:      entry.content,
      shortBody: entry.content, // originally entry.contentSnippet
      ...
      shortBodyPlain: entry.content.replace(/<img\b[^>]*.*?>/gi, ''),
